      ...
      <div class="container">
        ...
        <div class="row d-flex">
             <?php
                ...
                $query = "SELECT b.venue_id, b.user_id, b.event_date, b.session, b.deposit, b.status, v.venue_id , v.image, v.venue_name , v.venue_address, v.city FROM tbl_book as b INNER JOIN tbl_venue as v ON b.venue_id = v.venue_id where b.user_id = '$user_id' and b.status='A' order by b.event_date";
              ...
              <div class="inline-block">
                      ...
                      <?php
                        ...
                        if($eventDate == $today || $eventDate < $today || $before_date <= $today)
                        {
                            ...
                            echo "<a class='btn btn-outline-primary col-5' href='Customer_Feedback.php?venue_id=". $row['venue_id'] ."' style='color:black;float:right;'> <i class='fa fa-edit' style='font-size:18px;color:black'></i>  Give Feedback</a>";
                        }
                        else 
                        {
