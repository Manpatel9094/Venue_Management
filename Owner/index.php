                    ...
                    <div class="dropdown">
                        ...
                        <button class="btn btn-primary dropdown-toggle" type="button" id="dropdownMenu1" data-toggle="dropdown"
                            ...
                            <div class="dropdown-menu dropdown-primary">
                                <a class="dropdown-item" href="Membership_Pay.php"><i class='fas fa-rupee'></i>&nbsp;&nbsp; Get Membership</a>
                                
                                <hr>
                                
                                <a class="dropdown-item" href="Owner_Profile.php"><i class='fas fa-user-circle'></i>&nbsp;&nbsp; Profile</a>
                                <a class="dropdown-item" href="Owner_Wishlist.php"><i class='fas fa-heart'></i>&nbsp;&nbsp; My Wishlist</a>
                                <a class="dropdown-item" href="Owner_View_Booking.php"><i class='fas fa-bookmark'></i>&nbsp;&nbsp; My Booking</a>
        ...
        <div class="row d-flex">
            ...
            <div class="col-md-6 d-flex ftco-animate" style="text-align: center">
              ...
              <div class="text mt-3 float-right d-block">
                ...
                <a class="button success btn btn-primary" href="Membership_Pay.php">Add your venue</a>
              </div>
            </div>
          </div>
...
elseif($_SESSION['email_id']!=NULL && $_SESSION['user']=="Membership_Owner")
{
                    ...
                    <div class="dropdown">
                        ...
                        <button class="btn btn-primary dropdown-toggle" type="button" id="dropdownMenu1" data-toggle="dropdown"
                            ...
                            <div class="dropdown-menu dropdown-primary">
                                ...
                                <a class="dropdown-item" href="../Membership_Owner/index.php"><i class='fas fa-user-circle'></i>&nbsp;&nbsp; Back To Your Dashboard</a>
        ...
        <div class="row d-flex">
            ...
            <div class="col-md-6 d-flex ftco-animate" style="text-align: center">
              ...
              <div class="text mt-3 float-right d-block">
                ...
                <a class="button success btn btn-primary" href="../Membership_Owner/Add_Venue.php">Add your venue</a>
              </div>
            </div>
          </div>
      ...
      <div class="container">
        ...
        <div class="row block-9">
          <div class="col-md-7 order-md-last d-flex">
            <form action="#" class="bg-light p-4 p-md-5 contact-form">
              <div class="form-group">
                  <input type="text" style="width:50%;" class="form-control" placeholder="Your Name">
              </div>
              <div class="form-group">
                <input type="text" style="width:50%;"class="form-control" placeholder="Your Email">
              </div>
              <div class="form-group">
                <input type="text" style="width:50%;"class="form-control" placeholder="Subject">
              </div>
              <div class="form-group">
                <textarea name="" style="width:50%;" id="" cols="30" rows="7" class="form-control" placeholder="Message"></textarea>
              </div>
              <div class="form-group">
                <input type="submit" value="Send Message" class="btn btn-primary py-3 px-5">
              </div>
