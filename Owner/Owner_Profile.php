...
<!--        <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light site-navbar-target" id="ftco-navbar">
        ...
        <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav nav ml-auto">
                    <li class="nav-item"><a href="Customer_Index.php" class="nav-link" style="color : #004085" ><span>Home</span></a></li>
                    <li class="nav-item cta"><a href="#" class="nav-link body1" onclick="login-trigger" data-target="#login" data-toggle="modal">Change password</a></li> &nbsp;&nbsp;&nbsp;
    ...
    <div class="profile-card">
      ...
      <div class="img-wrapper">
          ...
          <h6 class="name" style="text-align: center;color: green;"><b>STATUS : <?php if($status == 'A'){echo "ACTIVE";} ?></b> &nbsp; <i class="fas fa-check-circle" style="font-size:17px"></i></h6>
          
          <br>
          
          <center><a class="btn btn-outline-primary" href="Owner_Update_Profile.php"><li class="fa fa-edit"></li> Edit Profile</a></center>
      ...
      <div class="text-wrapper">
        ...
        <?php
            ...
            echo "<a class='btn btn-danger' href='Owner_Delete.php?user_id=". $user_id ."'><li class='fa fa-trash'></li> Delete Profile</a>";
        ?>
