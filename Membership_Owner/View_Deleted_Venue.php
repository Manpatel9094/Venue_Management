    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="content">
            <div class="animated fadeIn">
                ...
                <div class="header">       
                    <center><h2><b><u>Deleted Venue Details</u></b></h2><br>
                               <h4>[ If Your Venue Is Deactive Then Active Your Venue. ]</h4></center>
                </div>
                ...
                <?php
                    $sql = "SELECT * FROM tbl_venue where user_id = '$user_id' and status='D'";
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <?php
                                            ...
                                            if($status == 'D')
                                            {
                                                echo "<b style='color:red'>" . $status = "DEACTIVE" . " <li class='fa fa-toggle-off'></li></b></br>";
                                            }
